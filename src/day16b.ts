import { FindSanta as FindSantaFromDay12 } from './day12b';

type FindSanta<T extends string[][], Counter extends number[] = []> = FindSantaFromDay12<
  T[Counter['length']]
> extends never
  ? FindSanta<T, [0, ...Counter]>
  : [Counter['length'], FindSantaFromDay12<T[Counter['length']]>];
